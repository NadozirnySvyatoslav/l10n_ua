...
def migrate(cr, version):
    ...
    From 20.0.7.0.0 `hr.version.staffing_line_id` is computed from
    ...
    if not _column_exists(cr, 'hr_version', 'staffing_line_id'):
        _logger.info(
            "l10n_ua_hr_contract 20.0.7.0.0: hr_version.staffing_line_id "
    ...
    _logger.info(
        "l10n_ua_hr_contract 20.0.7.0.0: snapshotted %s versions into %s, "
